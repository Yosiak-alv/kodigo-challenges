import {getUsers} from "../../services/user/UserService.js";
...
const Index = () => {
    ...
    const {isLoading,isSuccess, isError, data: users, error } = getUsers();
                    ...
                    <div
                        ...
                        <div className="p-6">
                            <div className="flex flex-wrap justify-between items-center p-5 ">
                                <h1 className="text-5xl font-semibold mb-4">Users</h1>
                                <BaseButton onClick={() => navigate("/users/create")}>
                                    Create User
                                </BaseButton>
                            </div>
