...
import { update, findById } from "../../services/useProducts.jsx";
...
const Edit = () => {
    ...
    const { loading: loadingShow, data: product,  error:errorShow } = findById(id);
    const {updateProduct, loading, data, error } = update();
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div
                        ...
                        <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                            <h1 className="text-2xl font-semibold text-gray-800 mb-4">Edit Product</h1>
